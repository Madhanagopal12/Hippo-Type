...
function randomWord() {
  ...
  return wordSplit[randomIndex - 1];
}
...
document.getElementById("game").addEventListener("keyup", (ev) => {
  ...
  const excepted = currentLetter?.innerHTML || " ";
  ...
  if (isLetter) {
    if (currentLetter) {
      addClass(currentLetter, key === excepted ? "correct" : "incorrect");
...
nextSibbling  --  returns the next sibblings
